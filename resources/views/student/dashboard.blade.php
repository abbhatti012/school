...
<section class="nicdark_section">
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_12">
            <h1 class="subtitle greydark">Point Value</h1>
            <div class="nicdark_space20"></div>
            <h3 class="subtitle grey">Instruction goes here</h3>
            <div class="nicdark_space20"></div>
        ...
        <div class="grid grid_4 nicdark_relative">
            ...
            <div class="nicdark_btn_iconbg nicdark_bg_yellow nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                <div>
                    <i class="fa fa-directions nicdark_iconbg left big white"></i> 
                </div>
            </div>
            
            <div class="nicdark_activity nicdark_marginleft100">         
                <div class="nicdark_space20"></div>
                <p> Lorem ipsum dolor sit amet, consec adipiscing elit. Pellentesque tincidunt rutrum sapien, sed ultricies diam.
                ...
                <div class="nicdark_space20"></div>
                <a href="#" class="nicdark_btn grey"><i class="fa fa-arrow-down"></i> More</a>
                <div class="nicdark_space20"></div>
            </div>
        </div>
        <div class="nicdark_space50"></div>
